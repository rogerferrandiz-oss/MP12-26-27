# RESUM (capítol)
(Albert) L'oferta és el document més important d'un projecte. Com millor es fa una oferta, menys problemes tens mentre el fas, i millor surt. Són els fonaments sobre els quals es construeix el mateix.
...
``` destacat-warning
1. **Les ofertes no són una garantia de projecte**. És norma general demanar dos o tres pressupostos per la mateixa feina per part d'un client, i només s'adjudicarà una de les ofertes. Normalment, el client estudia les propostes rebudes, i agafa la que li sembla millor en equilibri de tres aspectes: proposta, preu i calendari.
...
<!-- Placeholder. Link a l'exemple de fitxa de client (encara no la tenim, només un exemple) -->
...
<!-- Link a la plantilla de clarificació -->
...
- Deixa que et torni a explicar per què vol contractar-nos. Segurament et donarà més informació.
...
<!-- Gràfic Excalidraw / Mermaid que relaciona els tres documents] -->

Com ja us ha comentat la Lídia, fer bé i lligar bé els tres documents ajuda a que el projecte sigui un èxit. No només perquè el client entén bé què rebrà al final del contracte, sinó per vosaltres, que tindreu una manera de saber en tot moment si el projecte va bé o no. I no és tan senzill com sembla. De vegades el client no et dona tot el temps que necessites i has de mirar de retallar, o és més car que no pensaves. O resulta que una de les coses que has de fer, no la saps fer encara.
