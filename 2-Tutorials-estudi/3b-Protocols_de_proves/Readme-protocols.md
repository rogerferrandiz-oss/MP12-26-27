...
## ELS PROTOCOLS DE PROVES (capítol)
...
### CARACTERÍSTIQUES DELS PROTOCOLS (subcapítol 1)
```bloc-dialeg
avatar: albert_formal
nom: Albert Serrano
rol: Mentor tècnic · Aperture Holistics Consulting
...
### ESTRUCTURA D'UN PROTOCOL DE PROVES (subcapítol 2)
```bloc-dialeg
avatar: albert_formal
nom: Albert Serrano
rol: Mentor tècnic · Aperture Holistics Consulting
...
```bloc-boto
text: Plantilla de redacció de protocol de proves
...
## EVIDÈNCIA I VERIFICACIÓ DELS RESULTATS (capitol)
...
### QUANTES PROVES NECESSITEU (subcapítol 2)
...
### PROVES UNITÀRIES DE COMPONENTS (subcapitol 1)
```bloc-dialeg
avatar: albert_formal
nom: Albert Serrano
rol: Mentor tècnic · Aperture Holistics Consulting
...
### PROVES UNITÀRIES DE CONFIGURACIONS (subcapitol 2)
```bloc-dialeg
avatar: albert_formal
nom: Albert Serrano
rol: Mentor tècnic · Aperture Holistics Consulting
...
### Com saber quines proves d'integració necessiteu (subcapitol 1)
```bloc-dialeg
avatar: albert_formal
nom: Albert Serrano
rol: Mentor tècnic · Aperture Holistics Consulting
...
### Fins on ha d'arribar una prova d'integració  (subcapitol 2)
```bloc-dialeg
avatar: albert_formal
nom: Albert Serrano
rol: Mentor tècnic · Aperture Holistics Consulting
...
### En quin ordre es passen (subcapítol 3)
```bloc-dialeg
avatar: albert_formal
nom: Albert Serrano
rol: Mentor tècnic · Aperture Holistics Consulting
...
### Quan una prova d'integració falla (subcapitol 4)
```bloc-dialeg
avatar: albert_formal
nom: Albert Serrano
rol: Mentor tècnic · Aperture Holistics Consulting
...
### Com ha de ser una bona prova d'acceptació (subcapitol 1)
```bloc-dialeg
avatar: lidia_formal
nom: Lídia García
rol: Recursos Humans i Qualitat · Aperture Holistics Consulting
...
### Si una prova falla davant el client (subcapitol 2)
```bloc-dialeg
avatar: lidia_formal
nom: Lídia García
rol: Recursos Humans i Qualitat · Aperture Holistics Consulting
